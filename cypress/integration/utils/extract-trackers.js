...
import peopleExtractor from "../../../src/utils/extract-trackers/extract-people";
import contextExtractor from "../../../src/utils/extract-trackers/extract-context";

describe("utils/extract-trackers", function() {
  it("extract-tracker", () => {
    let note = "This is a #test of Nomies #extractor(4) #home(0) #sleep(01:00:00) and #cheese #cheese #cheese";
...
describe("utils/extract-people", function() {
  it("extract-people", () => {
    let note = "This is a #test of @Nomies and @brandon_corbin @b41d34 #extractor(4) #home(0) #sleep(01:00:00) and #cheese #cheese #cheese";
