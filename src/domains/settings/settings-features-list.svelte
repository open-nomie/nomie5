...
<List>
  <ListItem
    ...
    description={Lang.t(
      "settings.feature-people-description",
      "Keep track of those you interact with the most"
    )}
  >
  ...
  <ListItem
    ...
    description={Lang.t(
      "settings.feature-dashboard-description",
      "A dedicated tab for creating custom views of your data"
    )}
  >
  ...
  <ListItem
    ...
    description={Lang.t(
      "settings.use-location-description",
      "Lookup location each time you save a log"
    )}
  >
    <div slot="right" class="ml-2">
      <ToggleSwitch
  ...
  <ListItem
    ...
    description={Lang.t(
      "settings.require-pin-description",
      "Require a pin to launch Nomie. Don't forget it!"
    )}
  >
    <div slot="right" class="ml-2">
      {#if hasPin}
