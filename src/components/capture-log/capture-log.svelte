...
<style lang="scss">
  ...
  :global(.mask-textarea .save-button, .mask-textarea .more-button, .mask-textarea .expand-button) {
    margin-bottom: 7px;
  }
  ...
  <div class="capture-log">
    ...
    <div class="container p-0">
      ...
      <div class="mask-textarea {$ActiveLogStore.lat || $ActiveLogStore.note.trim().length > 0 ? 'populated' : 'empty'}">
        ...
        <Button className=" expand-button" icon size="sm" on:click={Interact.toggleFocusedEditor}>
