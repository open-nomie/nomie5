export default {
  ...
  translation: {
    ...
    export: {
      ...
      "backup-description":
        "Create an importable backup file. This allows you to transfer your data from one device to another using a single file (JSON) that contains ALL your Nomie data.",
