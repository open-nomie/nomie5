export default {
  ...
  "dashboard": {
    ...
    "select-dashboard-to-move-widget": "Move widget to which dashboard?",
  ...
  "people": {
    ...
    "empty-message": "Track & monitor how you interact with your friends and family",
  ...
  "board": {
    "edit-sort": "Edit / Sort",
    "create-new-board": "Create a new Tab...",
