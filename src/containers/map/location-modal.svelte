  ...
  <Panel className="h-full">
    <header slot="header" class="n-toolbar-grid">
      <ToolbarGrid>
        ...
        <div slot="right">
          <Button type="clear" color="primary-bright" on:click={favorite}>
    ...
    {#if showModal}
      <section class="flex flex-col h-full">
        <div style="height:225px;" class="flex-grow-0 flex-shrink-0">
          <!-- MAP -->
          ...
          <div class="list-wrapper">
            <NSortableList
              ...
              <NItem
                ...
                <Text
                  truncate2
                  className="title {state.active && item.hash == state.active.hash ? 'text-primary' : ''}">
                  {item.name}
    ...
    {/if}
    <div slot="footer" class="flex-grow-0 flex-shrink-0">
      <div class="p-4">
        <Button block on:click={Interact.dismissPickLocation}>
